...
const VELOCITY_PARAMS = {
  minSpeed: 0.1,       // [최소 속도] 이 속도 이하일 때 선이 가장 굵게 나옵니다. (천천히 쓸 때)
  maxSpeed: 1.0,       // [최대 속도] 이 속도 이상일 때 선이 가장 얇게 나옵니다. (빠르게 쓸 때)
  ...
  smoothing: 0.5       // [보정 계수] 0.0 ~ 1.0. 값이 클수록 굵기 변화가 부드럽지만 반응이 느려질 수 있습니다.
};
